...
Let's think about why this works in the context of our example above. Suppose @fig-dag-magic-sens displays the true relationship between our exposure and outcome of interest, however we have an unmeasured confounder, historic high temperature, denoted by the dashed lines. The three key components above are described by 1) the arrow between 'Extra Magic Morning' and 'Average wait', 2) The arrow between 'Historic high temperature' and 'Extra Magic Morning', and 3) the arrow between 'Historic high temperature' and 'Average wait'.
