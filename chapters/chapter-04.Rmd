...
```{r mirrored-ps, fig.cap="Mirrored histograms of estimated propensity scores"}
ggplot() +
  geom_histogram(
...
3.  A single outlier in either group with respect to range could be a problem and warrant data inspection (do this here?) *look at the model coefs here*.

*note* When do we talk about trimming / matching?

*note*This may be a "nice" example -- should we also show a bad model (maybe only with ticket season or possibly overspecifying it)
