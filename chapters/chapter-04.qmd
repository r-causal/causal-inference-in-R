...
Now, having this as a concrete example of an attempt to construct a counterfactual scenario in the "real-world" there are several issues that we can immediate see, highlighting the difficulty in drawing such inference.
First, while the set up implies that the two individuals were similar prior to the precipitating event that dictated their future opposite directions, we can easily identify factors in which perhaps they differed.
For example, did Spike have Ice-T's musical talent?
...
Perhaps we can find someone else who is exactly like Ice-T who did not make the same decsion and see how they fare.
