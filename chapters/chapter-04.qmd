...
In practice, this is what we need to do in causal inference. Even randomized trials are limited to a single factual world, so we compare the average effects of groups with different exposures.
