...
Here are some other great examples of decriptive analyses.
...
Finally, as we'll see in CHAPTER REF, there are certain circumstances where we *can* make causal inferences, particularly in cases where we can randomize interventions. 
