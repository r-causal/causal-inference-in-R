...
```{r}
#| label: mirror-histogram-net-data-unweighted
...
```{r}
#| label: mirror-histogram-net-data-weighted
...
```{r}
#| label: bootstrap-estimates-net-data
#| message: FALSE,
#| warning: FALSE,
