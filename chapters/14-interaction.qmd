...
As defined in @sec-po, $Y(1)$ and $Y(0)$ denote potential outcomes under exposure $(X=1)$ and control $(X=0)$. $\mathbf{Z}$ is a vector of pre-treatment covariates. Thhe individual treatment effect can be written as
