...
Up to this point, we have used interaction terms in regression models to represent heterogeneous treatment effects: the effect of the exposure varies across levels of a covariate $\mathbf{Z}$. That is often pracitioners mean when they ask whether an effect "differs by subgroup." It can be  useful to distinguish two related but different ideas: **effect modification** and **interaction**. These terms are often used interchangeably, but they answer different causal questions. **Effect modification** asks whether the causal effect of treatment $X$ on outcome $Y$ differs across levels of some pre-treatment variable $Z$. In our notation, this is the question:
