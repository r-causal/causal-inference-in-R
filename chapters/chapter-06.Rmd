...
The medication they are given is no longer random; it is *conditional* on factors about that patient, also known as the patient's *covariates*. If these covariates also affect the outcome, they are *confounders*.
