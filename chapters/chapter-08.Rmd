...
The weights here are changing the distribution of the variables by up or down weighting each of the observations so that the two groups appear balanced.
...
```{r}
library(halfmoon)
ggplot(seven_dwarfs_with_ps, aes(.fitted, group = extra_magic_morning)) +
