...
Much ink has been spilled about the odds ratio versus the risk ratio and the multiplicative scale versus the additive scale. We suggest that you present all three measures (the odds ratio, the risk ratio, and the risk difference) together with the baseline risk. Each offers a different perspective on the causal effect. Be careful to interpret them with regard to the treatment group, e.g., the average risk difference among the treated.
