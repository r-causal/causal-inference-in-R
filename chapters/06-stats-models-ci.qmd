...
We around get the correct answer within binned levels of users.
...
This is only partially true for continuous confounders because it's not practical to bin within all levels of the continuous variable.

Stratification can be powerful for simple problems or when you have lots of data because you sometimes avoid model misspecification problems.
However, with many confounders and continuous confounders, we quickly encounter the curse of dimensionality, making it impractical because we have too few observations by combinations of confounder levels.
...
This is also sometimes called **direct adjustment** because we adjust for the confounders directly in the model.
...
OLS can be very beneficial if we understand the relationships between the outcome and the variables in the regression.
