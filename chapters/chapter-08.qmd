...
As defined in the @sec-counterfactuals, <!--TODO make sure that this is defined in the previous chapter --> an exposure in the context of this book is often a modifiable event or condition that occurs prior to the outcome.
