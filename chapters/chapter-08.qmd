...
#| label: tbl-df-ps 
#| tbl-cap: > 
#|   The first six observations in the `seven_dwarfs_17_with_ps` dataset, including their propensity scores in the `.fitted` column.
seven_dwarfs_17_with_ps |> 
  select( 
    .fitted, date, extra_magic_morning, wdw_ticket_season, 
    close, weather_wdwhigh
    ) |>
  head() |> 
  knitr::kable()
```
