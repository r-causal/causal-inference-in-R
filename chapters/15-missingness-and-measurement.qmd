...
1. Your imputation model *must include all variables* that appear in your final outcome model and your propensity score model. This includes variables that confound the treatment–outcome relationship, the treatment, *and the outcome itself*. Leaving out key variables, especially the outcome, can lead to biased estimates. [@d2024behind]
