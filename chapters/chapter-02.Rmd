...
1.  Re-sample `this_data` with replacement. The same row may appear multiple (or no) times in a given bootstrap sample, simulating the sampling process in the underlying population.
