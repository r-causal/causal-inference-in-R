...
if (system.file(package = "tipr") == '') {
  remotes::install_github("lucymcgowan/tipr")
}

lapply(c('propensity', 'halfmoon', 'causalworkshop'), function(pkg) {
...
In this example, the unweighted distributions are not awful, but the weighted distributions are much more similar.
...
The `tip_coef()` function takes an estimate (a beta coefficient from a regression model).
