...
-   Sometimes it is also not ethical to conduct a trial, as is often the case in smoking studies.
    Imagine a circumstance where bed net use was closely associated with fire risk, much more than is observed in real life: would it be ethical to then assign someone to bed net use?
    In this scenario, real-world data might be the only way we can answer questions about malaria risk and bed nets.
...
> individual\'s risk of contracting malaria.
> They have collected data from
...
> The data is **not experimental**---researchers have no
