...
lapply(c('tidyverse', 'ggdag', 'ggokabeito', 'broom', 'rsample', 'remotes'), function(pkg) {
...
options(
  ...
  width = 55, 
  digits = 4,
  ggplot2.discrete.colour = palette_okabe_ito(),
  ggplot2.discrete.fill = palette_okabe_ito(),
